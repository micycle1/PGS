...
public final class PoissonDistribution {
	 ...
	 **/
	public List<PVector> generate(float xmin, float ymin, float xmax, float ymax, float minDist, int rejectionLimit) {
		this.xmin = xmin;
		this.xmax = xmax;
		this.ymin = ymin;
		this.ymax = ymax;
		...
		points.clear();
		LinkedList<PVector> processList = new LinkedList<>(); // active list
