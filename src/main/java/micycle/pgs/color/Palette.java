...
public enum Palette {
	...
	// @formatter:off
		...
		BANANABERRY(new String[] { "#ffffbf", "#f2f218", "#660535", "#f260e3", "#ffbff8" }),
		BASE(new String[] { "#f0f0f0", "#8c8c8c", "#0f0f0f", "#0863d3", "#f5d216", "#f43809", "#08b233", "#9913bf" }),
		...
		DAILY(new String[] { "#131314", "#272829", "#ffe18e", "#fff0c6" }),
		...
		IRIS(new String[] { "#ebedec", "#71859d", "#f6d448", "#fafafa" }),
		JELLY(new String[] { "#102340", "#fe01ec", "#8a07da" }),
		LAB(new String[] { "#061922", "#e5d62d", "#e52dbd", "#982de5", "#92f0e5" }),
		...
		PODCAST(new String[] { "#584594", "#e488b7", "#d74c41", "#f0d235", "#36ad63", "#69bcea", "#fdfdfd" }),
		POET(new String[] { "#f4f3ed", "#efc807", "#ed5d53", "#e2dbb5", "#45291c", "#080b0f" }),
		RAINBOW(new String[] { "#BF616A", "#D08770", "#EBCB8B", "#A3BE8C", "#B48EAD" }),
		REPETITION(new String[] { "#2c2060", "#4bd3e5", "#fffbe6", "#ffd919", "#ff4f19" }),
		RIGHT(new String[] { "#4464a1", "#62b6de", "#b3dce0", "#fafafa", "#ffc5c7", "#ee726b", "#cd1440"}),
		SCIENCE(new String[] { "#ffe819", "#000000" }),
		SHEETS(new String[] { "#025760", "#7fd0d3", "#b3ead7", "#eff7F5", "#fae9c1", "#f8ca75", "#e88d44" }),
		SLUSSEN(new String[] {"#fafafa", "#f398c3", "#f44e24", "#f4d730", "#23b247", "#2a76d3", "#0a0a0a"}),
	...
	private Palette(String[] value) {
		this.value = value;
		this.intValue = ColorUtils.hexToColor(value);
		length = value.length;
	}
	...
	public int get(int index) {
		...
		int positiveIndex = (index >= 0) ? index : length + (index % length);
