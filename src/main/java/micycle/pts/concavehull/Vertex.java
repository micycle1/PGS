...
class Vertex {
	...
	/**
	 * Indicator to know if the vertex is a border vertex of the triangulation
	 * framework
	 */
	 ...
	 * 
	 * @param id     ID of the vertex
	 * @param border defines if the vertex is a border vertex or not in the
	...
	/**
	 * Returns true if the vertex is a border vertex of the triangulation framework,
	 * false otherwise.
	 * 
	 * @return true if the vertex is a border vertex, false otherwise
	 */
	...
	/**
	 * Defines the indicator to know if the edge is a border edge of the
	 * triangulation framework.
	 * 
	 * @param border true if the edge is a border edge, false otherwise
	 */
