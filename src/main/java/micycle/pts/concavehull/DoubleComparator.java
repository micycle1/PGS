 ...
 *
 */
class DoubleComparator implements Comparator<QuadEdge> {
	 ...
	 * @return 1 if double value associated to qeA < double value associated to qeB,
	 *         0 if values are equals, -1 otherwise
	 */
	@Override
