...
class Triangle {
	...
	/**
	 * Indicator to know if the triangle is a border triangle of the triangulation
	 * framework
	 */
	 ...
	 * 
	 * @param id     ID of the triangle
	 * @param border defines if the triangle is a border triangle or not in the
	 ...
	 * triangulation framework.
	 * 
	 * @param border true if the triangle is a border triangle, false otherwise
	 */
	 ...
	 * 
	 * @param edges the edges which compose the triangle
	 */
	 ...
	 * 
	 * @param neighbours the neighbour triangles of the triangle
	 */
