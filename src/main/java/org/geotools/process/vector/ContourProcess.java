...
public class ContourProcess implements VectorProcess {
	...
	public SimpleFeatureCollection execute(
			@SuppressWarnings("rawtypes") @DescribeParameter(name = "features", description = "Input point feature collection") FeatureCollection features,
			...
			// @DescribeParameter(name = "nice", description = "Should the contours start
			// and end at
			...
			// @DescribeParameter(name = "roi", description = "Geometry delineating the
			// region of
